...
export class TradingReportComponent implements OnInit {
  ...
  constructor(private dataService: DataService) {
    ...
    this.columns = [
      ...
      this.data = [
        [1,2,3,4,35,6,7,8,9,'as12d','dseef','d11f'],
        [1,2,3,34,5,6,7,8,91,'asasaad','drewtwetsf','drrf'],
        [1,25,3,4,5,6,71,8,9,'aswrerd','dffdsf','dfcdv'],
        [1,2,35,4,5,36,7,85,9,'asdxcv','vvvdsf','nnndf'],
        [1,2,3,44,5,6,7,8,9,'as12d','dsewqef','dffgergerg'],
        [1,2,3,4,35,6,7,8,9,'as12d','dseef','d11f'],
        [1,2,3,34,5,6,7,8,91,'asasaad','drewtwetsf','drrf'],
        [1,25,3,4,5,6,71,8,9,'aswrerd','dffdsf','dfcdv'],
        [1,2,35,4,5,36,7,85,9,'asdxcv','vvvdsf','nnndf'],
